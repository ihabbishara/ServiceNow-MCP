...
export const createApp =
  ...
  async (req: IncomingMessage, res: ServerResponse): Promise<void> => {
    ...
    try {
      ...
      if (m === "POST /api/knowledge/upload")
        return void (await handleUpload(req, res, host, host.uploadMaxBytes));
      ...
      if (m === "DELETE /api/knowledge/sources")
        return void (await handleDeleteSource(req, res, host));
